...
function CharacterProfile({ handleSubmit, handleChange, profData }) {
    return (
        <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="col-span-1">
                    <label className="block mb-1  font-dragon underline">Name:</label>
                    <input
                        type="text"
                        name="name"
                        value={profData.name}
                ...
                <div className="col-span-1">
                    <label className="block mb-1 underline font-dragon ">Class:</label>
                    <input
                        type="text"
                        name="klass"
                        value={profData.klass}
                ...
                <div className="col-span-1">
                    <label className="block mb-1 font-dragon underline">Level:</label>
                    <input
                        type="number"
                        name="level"
                        value={profData.level}
                ...
                <div className="col-span-1">
                    <label className="block mb-1 underline font-dragon">Background:</label>
                    <input
                        type="text"
                        name="background"
                        value={profData.background}
                ...
                <div className="col-span-1">
                    <label className="block mb-1 font-dragon underline">Race:</label>
                    <input
                        type="text"
                        name="race"
                        value={profData.race}
                ...
                <div className="col-span-1">
                    <label className="block mb-1 underline font-dragon" >XP:</label>
                    <input
                        type="number"
                        name="xp"
                        value={profData.xp}
                ...
                <div className="col-span-1">
                    <label className="block mb-1 underline font-dragon">Alignment:</label>
                    <input
                        type="text"
                        name="alignment"
                        value={profData.alignment}
